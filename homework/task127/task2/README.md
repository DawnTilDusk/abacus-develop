...
| [source/source_estate/test_omp/charge_omp_test.cpp](file:///root/homework/abacus-develop/source/source_estate/test_omp/charge_omp_test.cpp) | 阶段 2 + 4 + 5 + 6 + 7 累计扩展 | `_OPENMP` 健全性 + 2 reorder + 1 extract + 5 边界 + 1 perf benchmark（默认 skip） |
